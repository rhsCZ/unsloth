...
export function ApiMonitorPage(): ReactElement {
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl 3xl:max-w-[1440px] 4xl:max-w-[1760px] flex-col gap-6 px-6 pb-10 pt-12 max-sm:px-4 max-sm:pt-8 font-heading sm:px-10">
      ...
      <section className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-border/60 bg-card">
        ...
        >
          <div className="max-h-[560px] min-h-[220px] max-lg:max-h-[45dvh] 3xl:max-h-[calc(100dvh-22rem)] overflow-y-auto border-b border-border/60 lg:border-b-0 lg:border-r">
            {loading ? (
          ...
          <div className="max-h-[560px] min-h-[220px] max-lg:max-h-[45dvh] 3xl:max-h-[calc(100dvh-22rem)] overflow-y-auto">
            {selected ? (
              <RequestDetail
                entry={selected}
