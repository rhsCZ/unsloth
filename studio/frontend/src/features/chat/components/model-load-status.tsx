...
export function ModelLoadInlineStatus({
  ...
  return (
    <div className="flex min-w-[20rem] max-sm:min-w-0 max-sm:flex-1 items-center gap-2.5 text-muted-foreground" title={title}>
      ...
      {hasProgress ? (
        <div className="flex min-w-0 flex-[1.35] items-center gap-2.5">
          <div className="min-w-[7rem] max-sm:min-w-[3rem] flex-1">
