      ...
      >
        ...
        >
          ...
          <PopoverContent
            ...
            className="hub-menu-instant menu-soft-surface w-[var(--radix-popover-trigger-width)] min-w-[300px] max-sm:min-w-0 max-sm:max-w-[calc(100vw-1rem)] gap-0 overflow-hidden p-0 py-2 ring-0"
          >
