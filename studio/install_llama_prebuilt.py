...
def validate_prebuilt_choice(
    ...
    *,
    ...
    # Staged runtime validation is gated behind _RUN_STAGED_PREBUILT_VALIDATION,
    # disabled for now to avoid the cold CUDA-JIT cost (minutes on Blackwell sm_100)
    # on every install and update. The smoke tests and the source-build fallback
    # they trigger are kept intact -- flip the flag to True to restore them.
